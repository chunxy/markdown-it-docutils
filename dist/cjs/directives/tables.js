...
exports.tables = exports.ListTable = void 0;
const syntaxTree_1 = require("../syntaxTree");
const main_1 = require("./main");
const options_1 = require("./options");
class ListTable extends main_1.Directive {
    constructor() {
        super(...arguments);
        ...
        this.option_spec = {
            "header-rows": options_1.nonnegative_int,
            "stub-columns": options_1.nonnegative_int,
            width: options_1.length_or_percentage_or_unitless,
            widths: options_1.unchanged,
            class: options_1.class_option,
            name: options_1.unchanged,
            align: (0, options_1.create_choice)(["left", "center", "right"])
        };
    }
    run(data) {
        ...
        if (listTokens.length < 2 ||
            ...
            throw new main_1.DirectiveParsingError("Content is not a single bullet list");
        }
        // generate tokens
        const tokens = [];
        // table opening
        ...
        let rowNumber = 0;
        for (const child of new syntaxTree_1.SyntaxTreeNode(listTokens.slice(1, -1)).children) {
            rowNumber += 1;
